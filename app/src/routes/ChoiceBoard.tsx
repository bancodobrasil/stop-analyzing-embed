        ...
        <div className="col-12 my-auto">
          <div className="row text-center">
            <div className="col-lg-12 mb-4">
              <H3>
                {t('Which one would you like to choose?')} <TimerComponent timeout={15} />
              </H3>
              <div className="col-lg-12 mb-4">
          ...
          <div className="row text-center">
            ...
            <div className="col-lg-6 mb-4">
              <Card title={t('Choice 2')} paragraph={t('Nope, that\'s a good choice!')} imageURL="https://picsum.photos/seed/x2/200/300" />
            </div>
          </div>
        </div>
      </div>
